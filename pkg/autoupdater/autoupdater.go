...
const (
	UPDATE_SOURCE = "marcus-crane/wails-autoupdater"
)
...
func PerformUpdateDarwin(currentVersion string) (bool, error) {
	...
	downloadPath := filepath.Join(homeDir, "Downloads", "wails-autoupdater.zip")
	...
	installPath = strings.TrimSuffix(cmdPath, "wails-autoupdater.app/Contents/MacOS/wails-autoupdater")
	if err != nil {
